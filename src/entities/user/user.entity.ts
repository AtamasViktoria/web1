import { Column, Entity, PrimaryGeneratedColumn } from 'typeorm'; // Исправлено: добавлена точка с запятой

import { E_Gender } from './types'; // Исправлено: добавлена точка с запятой
